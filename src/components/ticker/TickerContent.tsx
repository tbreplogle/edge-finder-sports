  ...
  return <div className="relative w-full">
      ...
      slidesToScroll: 1
        ...
        <CarouselContent className="-ml-2 sm:-ml-3">
          {games.length > 0 ? games.map(game => <CarouselItem key={game.id} className="pl-2 sm:pl-3 basis-auto max-w-fit">
                <TickerGameItem game={game} />
              </CarouselItem>) : <CarouselItem className="pl-2 sm:pl-3 basis-full">
